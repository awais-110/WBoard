...
export default function BottomToolbar({ fabricRef, onUndo, onRedo }: BottomToolbarProps) {
  ...
  return (
    <div className="pointer-events-none absolute inset-x-0 bottom-5 z-30 flex justify-center">
      <div className="pointer-events-auto flex items-center gap-1.5 rounded-full border border-[#2a2a2a] bg-[#1a1a1a]/90 px-2 py-2 text-white shadow-2xl backdrop-blur">
        ...
        <div className="mx-1 h-7 w-px bg-[#2a2a2a]" />
        <label className="relative inline-flex h-10 w-10 cursor-pointer items-center justify-center rounded-lg hover:bg-[#2a2a2a]" title="Stroke color">
        ...
        <label className="relative inline-flex h-10 w-10 cursor-pointer items-center justify-center rounded-lg hover:bg-[#2a2a2a]" title="Fill color">
        ...
        <div className="mx-1 h-7 w-px bg-[#2a2a2a]" />
        <button type="button" onClick={onUndo} className="inline-flex h-10 w-10 items-center justify-center rounded-lg text-white/70 transition-colors hover:bg-[#2a2a2a] hover:text-white" title="Undo">
          <RotateCcw size={18} />
        </button>
        <button type="button" onClick={onRedo} className="inline-flex h-10 w-10 items-center justify-center rounded-lg text-white/70 transition-colors hover:bg-[#2a2a2a] hover:text-white" title="Redo">
          <RotateCw size={18} />
        </button>
        <div className="mx-1 h-7 w-px bg-[#2a2a2a]" />
        <button
          ...
          className="inline-flex h-10 w-10 items-center justify-center rounded-lg text-white/70 transition-colors hover:bg-[#2a2a2a] hover:text-white"
          title="Zoom out"
        >
          <ZoomOut size={16} />
        </button>
        <div className="min-w-16 rounded-lg bg-[#0f0f0f] px-3 py-2 text-center text-sm font-semibold text-white/80">
          {Math.round(zoom * 100)}%
        </div>
        <button
          type="button"
